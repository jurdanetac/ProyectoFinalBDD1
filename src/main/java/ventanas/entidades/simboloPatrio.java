...
public class simboloPatrio extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    bg.add(volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 90, -1));
    ...
    bg.add(editar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, 90, -1));
    ...
    bg.add(eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, -1, -1));
    ...
    bg.add(verDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 50, -1));
  ...
  private void anadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anadirActionPerformed
    JFrame nuevoSimboloPatrio = new ventanas.anadir.simboloPatrio();
    this.setVisible(false);
    nuevoSimboloPatrio.setVisible(true);
  ...
  private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
    String simboloPatrio = lista.getSelectedValue().toString().split(" ")[0];

    JFrame editarSimbolo = new ventanas.editar.simboloPatrio(simboloPatrio);
    this.setVisible(false);
    editarSimbolo.setVisible(true);
  }//GEN-LAST:event_editarActionPerformed

  private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
    String simboloPatrio = lista.getSelectedValue().toString().split(" ")[0];

    utils.actualizarBase.eliminar("simbolo_patrio", "id", simboloPatrio);
  ...
  private void verDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verDatosActionPerformed
    utils.ConsultaPane.consultaPane("simbolo_patrio", lista.getSelectedValue().split("-")[0].trim(), "");
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(simboloPatrio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
