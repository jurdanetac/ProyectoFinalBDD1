...
public class serVivo extends javax.swing.JFrame {
  ...
  private void verDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verDatosActionPerformed
    String[] seleccion = lista.getSelectedValue().split("-");
    String[] nombreCientifico = seleccion[1].split(" ");

    utils.ConsultaPane.consultaPane("ser_vivo", nombreCientifico[1].trim(), nombreCientifico[2].trim());
