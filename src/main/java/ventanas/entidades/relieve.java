...
public class relieve extends javax.swing.JFrame {
  ...
  private void anadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anadirActionPerformed
    JFrame nuevoRelieve = new ventanas.anadir.relieve();
    this.setVisible(false);
    nuevoRelieve.setVisible(true);
  ...
  private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
    String relieve = lista.getSelectedValue().toString();

    JFrame editarRelieve = new ventanas.editar.relieve(relieve);
    this.setVisible(false);
    editarRelieve.setVisible(true);
  }//GEN-LAST:event_editarActionPerformed

  private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
    String relieve = lista.getSelectedValue().toString();

    utils.actualizarBase.eliminar("relieve", "tipo", relieve);
